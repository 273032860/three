    ...
    <>
      <group dispose={null}>
        <mesh
          ...
          <primitive attach="material" object={material1} color={opts.color} map={opts.materialMap?texture:null} wireframe={opts.wireframe?true:false} transparent opacity={opts.opacity} alphaMap={opts.materialAlphaMap?texture:null} side={opts.materialSide?THREE.DoubleSide:null}   flatShading={opts.flatShading?true:false}  metalness={opts.metalness} roughness={opts.roughness} shininess ={100}  specular='blue'  />
        </mesh>
        {/* <mesh
